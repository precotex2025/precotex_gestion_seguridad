...
export class UsuariosPersonasComponent implements OnInit {
  ...
  mockPersonas: any[] = [
    ...
    },
    {
      ...
      nombre: 'Elizabet',
      apellidos: 'Rivera',
      nombreCompleto: 'Elizabet Rivera',
      email: 'erivera@precotex.com.pe',
      telefono: '987654322',
      codigo_Organizacion: '01',
      organizacion: 'Precotex S.A.C.',
      codigo_Sede: '01',
      ...
      proxima: '10/11/2026',
      estado_evaluacion: 'True',
      proxima_evaluacion_plan: '10/05/2027',
      permisos: {}
    },
    {
      codigo_Persona: 'P004',
      nombre: 'Cesar',
      apellidos: 'Lingan',
      nombreCompleto: 'Cesar Lingan',
      email: 'clingan@precotex.com.pe',
      telefono: '987654323',
      codigo_Organizacion: '01',
      organizacion: 'Precotex S.A.C.',
      codigo_Sede: '01',
      ...
      codigo_Nivel_Riesgo: 'BAJO',
      nivelRiesgo: 'BAJO',
      flg_Activo: 'True',
      es_admin: 'No',
      proxima: '12/12/2026',
      estado_evaluacion: 'True',
      proxima_evaluacion_plan: '12/06/2027',
      permisos: {}
    },
    {
      codigo_Persona: 'P005',
      nombre: 'Mary',
      apellidos: 'Guevara',
      nombreCompleto: 'Mary Guevara',
      email: 'mguevara@precotex.com.pe',
      telefono: '987654324',
      codigo_Organizacion: '01',
      organizacion: 'Precotex S.A.C.',
      codigo_Sede: '01',
      ...
      proxima: '18/01/2027',
      estado_evaluacion: 'True',
      proxima_evaluacion_plan: '18/07/2027',
      permisos: {}
    },
    {
      codigo_Persona: 'P006',
      nombre: 'Alfredo',
      apellidos: 'Toro',
      nombreCompleto: 'Alfredo Toro',
      email: 'atoro@precotex.com.pe',
      telefono: '987654325',
      codigo_Organizacion: '01',
      organizacion: 'Precotex S.A.C.',
      codigo_Sede: '01',
      ...
      proxima: '20/02/2027',
      estado_evaluacion: 'True',
      proxima_evaluacion_plan: '20/08/2027',
      permisos: {}
    }
  ];
